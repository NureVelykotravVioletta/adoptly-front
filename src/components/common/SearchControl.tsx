  ...
  return (
    ...
    >
      <input
        ...
        className={clsx(
          "h-10 w-full rounded-full border border-[#E2E2E2] bg-white pr-11 pl-4 text-sm text-[#262626] outline-none transition placeholder:text-[#B6B6B6] focus:border-[#8456F0]",
          inputClassName
        )}
      />
      <button
